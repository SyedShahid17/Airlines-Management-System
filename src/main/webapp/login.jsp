...
body {
	background-image: linear-gradient(rgba(0, 0, 0, 0.45), 
		rgba(0, 0, 0, 0.45)), url("airline1 - Copy.jpeg");
...
<body>
	<div class="content">
		...
		<div class="loginbox">
			<img src="OIP - Copy.jpg " class="avatar">
			<form name="form" method="post" action="logincheck.jsp"
				...
				<input id="pass" type="password" name="pass"
					...
					type="checkbox" onclick="myFunction()">Show Password <input
					type="submit" name="login" value="login"> <a
					href="forgot.jsp">forgot password?</a><br> <a
					href="register.jsp">create a new account!</a><br>
			</form>
		</div>
</body>
</html>