                            ...
                            <div class="resp-tabs-container">
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                    <div class="payment-info">
                                        ...
                                        <form action="success.jsp" method="post">
                                            <div class="tab-for">
                                                <h5>Amount</h5><P>7500</P>
                                                <!-- <input class="pay-logo" type="text" value="₹.00" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '₹.00';}" required=""> -->
                                            </div>
                                            <div class="tab-for">
                                                <h5>NAME ON CARD</h5>
                                                 <input class="pay-logo" type="text" value="Enter the name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter the name';}" required="required">
                                                <h5>CARD NUMBER</h5>
                                                <input class="pay-logo" type="text" value="0000-0000-0000-0000" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '0000-0000-0000-0000';}" required="required">
                                            </div>
                                            <div class="transaction">
                                                <div class="tab-form-left user-form">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="number" class="text_box" type="text" value="0" min="1" required="required" />
                                                        </li>
                                                        <li>
                                                            <input type="number" class="text_box" type="text" value="2000" min="1" required="required"" />
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="tab-form-right user-form-rt">
                                                    <h5>CVV NUMBER</h5>
                                                    <input type="password" value="xxx" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'xxx';}" required="required">
                                                </div>
                                                <div class="clear"></div>
                                            </div>
                                            <input type="submit" >
                                ...
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                                    <div class="payment-info">
                                        ...
                                        <a class="confirm-btn" href="success.jsp">CONTINUE</a>
                                    </div>
                                </div>
                                        ...
                                        <form action="success.jsp" method="post">
                                            ...
                                            <div class="transaction">
                                                <div class="tab-form-left user-form">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="number" class="text_box" type="text" value="6" min="1" required="required" />
                                                        </li>
                                                        <li>
                                                            <input type="number" class="text_box" type="text" value="1988" min="1" required="required" />
                                                        </li>
